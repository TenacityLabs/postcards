...
export default function SignupDesktop(props: SignupDesktopProps) {
	const { email, setEmail, firstName, setFirstName, lastName, setLastName, displayName, setDisplayName, password, setPassword, isPasswordVisible, setIsPasswordVisible, isSigningUp, handleSignup, isFillingSenderInfo, setIsFillingSenderInfo, handleContinue } = props
